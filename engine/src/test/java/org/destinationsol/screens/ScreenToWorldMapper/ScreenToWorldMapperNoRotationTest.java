...
public class ScreenToWorldMapperNoRotationTest {
     ...
     * world when the cameras position is in the center
     */
    @Test
    public void screenToWorldMapper_ClickCenterOfScreen() {
        ...
        Vector2 worldPos = ScreenToWorldMapper.screenClickPositionToWorldPosition(
                new Vector2(screenWidth, screenHeight), clickPos, camPos, 0.0f, 1.0f);

        // As the users clicks on the center of the screen and when the camera is in the
        // center of the world,
    ...
    /**
     * Test that the a click on the center of a screen that is not equal of height
     * and width when the cameras position is in the center
     */
    @Test
    ...
    /**
     * Test that the a click on the center of the screen maps correctly to the
    ...
    public void screenToWorldMapper_ClickTopLeftOnScreen_WithCameraOffset() {
        ...
        assertEquals(
                new Vector2(5.0f, 5.0f).sub(new Vector2(0.5f, 0.5f).scl(ScreenToWorldMapper.PIXEL_TO_WORLD_UNIT_RATIO)),
                worldPos);
    }
