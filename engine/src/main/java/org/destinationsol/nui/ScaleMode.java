...
public enum ScaleMode {
    ...
    STRETCH {
        @Override
        public Vector2 scaleForRegion(Rectangle region, int actualWidth, int actualHeight) {
    ...
    SCALE_FIT {
        ...
        public Vector2 scaleForRegion(Rectangle region, int actualWidth, int actualHeight) {
            ...
            return new Vector2(actualWidth * scale, actualHeight * scale);
        }
     ...
     */
    public abstract Vector2 scaleForRegion(Rectangle region, int actualWidth, int actualHeight);
}
