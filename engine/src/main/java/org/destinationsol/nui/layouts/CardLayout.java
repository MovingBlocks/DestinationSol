...
public class CardLayout extends CoreLayout<LayoutHint> {
     ...
     * @param sizeHint A {@link Vector2} representing the space available for widgets to be drawn in this layout
     * @return A {@code Vector2} representing the preferred content size of this {@code CardLayout}
     */
    @Override
    public Vector2 getPreferredContentSize(Canvas canvas, Vector2 sizeHint) {
        ...
        for (UIWidget uiWidget : widgets.values()) {
            Vector2 preferredContentSize = uiWidget.getPreferredContentSize(canvas, sizeHint);
     ...
     *
     * @param canvas The {@code Canvas} on which this {@code CardLayout} is drawn
     * @return A {@code Vector2} representing the maximum content size of this {@code CardLayout}
     */
    @Override
    public Vector2 getMaxContentSize(Canvas canvas) {
        ...
        int maxY = 0;
        for (UIWidget uiWidget : widgets.values()) {
            Vector2 maxContentSize = uiWidget.getMaxContentSize(canvas);
