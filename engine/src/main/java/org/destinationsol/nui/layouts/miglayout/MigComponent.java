...
public class MigComponent implements ComponentWrapper {
    ...
    public void calculatePreferredSize(Canvas canvas, Vector2 sizeHint) {
        ...
        preferredSize = new Vector2(Math.max(sizeHint.x, minimumSize.x), Math.max(sizeHint.y, minimumSize.y));
    }
    ...
    public void setPreferredSize(Vector2 preferredSize) {
