...
public interface Canvas {
     ...
     */
    Vector2 calculatePreferredSize(UIWidget widget);
     ...
     */
    Vector2 calculateRestrictedSize(UIWidget widget, Vector2 sizeRestrictions);

    /**
     * Calculates the maximum size a widget can take. A dimension will be Vector2(Integer.MAX_VALUE, Integer.MAX_VALUE) if unbounded
     *
     * @param widget The widget to get the maximum size of.
     * @return The maximum size of the widget.
     */
    Vector2 calculateMaximumSize(UIWidget widget);
     ...
     * @param region
     */
    void drawWidget(UIWidget element, Rectangle region);
     ...
     * @param region
     */
    void drawText(String text, Rectangle region);
     ...
     */
    void drawTexture(TextureRegion texture, Rectangle region);
     ...
     */
    void drawTexture(TextureRegion texture, Rectangle region, Color color);
     ...
     * @param region
     */
    void drawBackground(Rectangle region);
     ...
     */
    SubRegion subRegion(Rectangle region, boolean crop);
     ...
     * @return A SubRegion, to be closed when no long needed
     */
    SubRegion subRegionFBO(ResourceUrn uri, Vector2 size);
     ...
     */
    void drawTextRaw(String text, Font font, Color color, Rectangle region);
     ...
     */
    void drawTextRaw(String text, Font font, Color color, Rectangle region, HorizontalAlign hAlign, VerticalAlign vAlign);
     ...
     * @param vAlign     The vertical alignment of the text
     */
    void drawTextRaw(String text, Font font, Color color, boolean underlined, Rectangle region, HorizontalAlign hAlign, VerticalAlign vAlign);
     ...
     */
    void drawTextRawShadowed(String text, Font font, Color color, Color shadowColor, Rectangle region);
     ...
     * @param vAlign      The vertical alignment of the text
     */
    void drawTextRawShadowed(String text, Font font, Color color, Color shadowColor, Rectangle region, HorizontalAlign hAlign, VerticalAlign vAlign);
     ...
     * @param vAlign      The vertical alignment of the text
     */
    void drawTextRawShadowed(String text, Font font, Color color, Color shadowColor, boolean underline, Rectangle region, HorizontalAlign hAlign, VerticalAlign vAlign);
     ...
     */
    void drawTextureRaw(TextureRegion texture, Rectangle region, ScaleMode mode);
     ...
     * @param mode    The method for adapting this texture to the region
     */
    void drawTextureRaw(TextureRegion texture, Rectangle region, Color color, ScaleMode mode);
     ...
     */
    void drawTextureRaw(TextureRegion texture, Rectangle region, ScaleMode mode, int ux, int uy, int uw, int uh);
     ...
     */
    void drawTextureRaw(TextureRegion texture, Rectangle region, ScaleMode mode, float ux, float uy, float uw, float uh);
     ...
     * @param uh      The height of the sub-region of the texture to draw, relative to the texture size
     */
    void drawTextureRaw(TextureRegion texture, Rectangle region, Color color, ScaleMode mode, float ux, float uy, float uw, float uh);
     ...
     */
    void drawTextureRawBordered(TextureRegion texture, Rectangle region, Border border, boolean tile);
     ...
     * @param uh      The height of the sub-region of the texture to draw, in pixels
     */
    void drawTextureRawBordered(TextureRegion texture, Rectangle region, Border border, boolean tile, int ux, int uy, int uw, int uh);
     ...
     * @param uh      The height of the sub-region of the texture to draw, relative to the texture size
     */
    void drawTextureRawBordered(TextureRegion texture, Rectangle region, Border border, boolean tile, float ux, float uy, float uw, float uh);
...
//     * @param region
//     */
//    void drawMaterial(Material material, Rectangle region);
//
//    /**
...
//     */
//    void drawMesh(Mesh mesh, Material material, Rectangle region, Quat4f rotation, Vector3f offset, float scale);
//
//    void drawMesh(Mesh mesh, Texture texture, Rectangle region, Quat4f rotation, Vector3f offset, float scale);
     ...
     * @param region
     */
    void addInteractionRegion(InteractionListener listener, Rectangle region);
     ...
     * @param region
     */
    void addInteractionRegion(InteractionListener listener, UIWidget tooltip, Rectangle region);
     ...
     * @param region
     */
    void addInteractionRegion(InteractionListener listener, String tooltip, Rectangle region);

    void drawLine(int startX, int startY, int endX, int endY, Color color);

    void drawFilledRectangle(Rectangle region, Color color);
}
