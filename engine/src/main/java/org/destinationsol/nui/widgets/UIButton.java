...
public class UIButton extends ActivatableWidget {
     ...
     * @param areaHint A {@link Vector2} representing the available space for this {@code UIButton}
     * @return A {@link Vector2} representing the preferred content size of the {@code UIButton}
     */
    @Override
