...
import org.destinationsol.nui.widgets.browser.ui.DocumentRenderer;
...
public class MultiBlockParagraphRenderable implements ParagraphRenderable {
    ...
    public void renderContents(Canvas canvas, Vector2 startPos, ContainerRenderSpace containerRenderSpace,
        ...
        DocumentRenderer.renderParagraphs(canvas, hyperlinkRegister, fallbackStyle, (int) startPos.x, (int)startPos.y + topIndents,
