 ...
 */
package org.destinationsol.nui.widgets.browser.data.basic;
...
import org.destinationsol.nui.widgets.browser.data.basic.flow.FlowLineBuilder;
import org.destinationsol.nui.widgets.browser.data.basic.flow.FlowRenderable;
import org.destinationsol.nui.widgets.browser.data.basic.flow.LaidFlowLine;
    ...
    public void renderContents(Canvas canvas, Vector2 startPos, ContainerRenderSpace containerRenderSpace, int leftIndent, int rightIndent,
        ...
        for (LaidFlowLine<FlowRenderable> line : updateCacheIfNeeded(defaultStyle, startPos.y, containerRenderSpace)) {
            ...
            for (FlowRenderable flowRenderable : line.getFlowRenderables()) {
                ...
                Rectangle renderableRegion = Rectangle.createFromMinAndSize(insetXAdvance + leftIndent + alignOffset + startPos.x + x, y, elementWidth, lineHeight);
