...
public interface ParagraphRenderable {
     ...
     */
    void renderContents(Canvas canvas, Vector2 startPos, ContainerRenderSpace containerRenderSpace, int leftIndent, int rightIndent,
    ...
    public interface HyperlinkRegister {
        void registerHyperlink(Rectangle region, String hyperlink);
    }
}
