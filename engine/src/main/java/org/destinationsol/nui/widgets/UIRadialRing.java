...
public class UIRadialRing extends CoreWidget {
    ...
    private void initialise(Canvas canvas) {
        ...
        Rectangle region = canvas.getRegion();
        ...
        Rectangle infoRegion = Rectangle.createFromMinAndSize(
        ...
        for (int i = 0; i < sections.size(); i++) {
            sections.get(i).setDrawRegion(Rectangle.createFromMinAndSize(
            ...
            sections.get(i).setInnerRegion(Rectangle.createFromMinAndSize(
    ...
    private int getSectionOver(Vector2 mousePos) {
        mousePos.x -= radius;
        mousePos.y -= radius;
