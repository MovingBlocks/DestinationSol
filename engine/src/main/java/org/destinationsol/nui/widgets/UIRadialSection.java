...
import org.destinationsol.nui.WidgetWithOrder;
...
public class UIRadialSection extends WidgetWithOrder {
    ...
    private Rectangle infoRegion;
    private Rectangle innerRegion;
    private Rectangle sectionRegion;
    ...
    public Vector2 getPreferredContentSize(Canvas canvas, Vector2 sizeHint) {
        return sectionRegion == null ? Vector2.zero() : sectionRegion.size();
    }
     ...
     */
    public void setInfoRegion(Rectangle newRegion) {
     ...
     */
    public void setDrawRegion(Rectangle region) {
     ...
     */
    public void setInnerRegion(Rectangle region) {
        innerRegion = region;
    }
}
