 ...
 */
package org.destinationsol.nui.widgets.browser.data.html.basic.list;
...
import org.destinationsol.nui.widgets.browser.data.html.basic.DefaultParagraphData;
import org.destinationsol.nui.widgets.browser.ui.ParagraphRenderable;
...
public class UnorderedListDecorator implements ListDecorator {
    ...
    private final class UnorderedListParagraphRenderable implements ParagraphRenderable {
        ...
        @Override
        public void renderContents(Canvas canvas, Vector2 startPos, ContainerRenderSpace containerRenderSpace, int leftIndent, int rightIndent,
            ...
            Rectangle bounds = Rectangle.createFromMinAndSize(startPos.x + leftIndent + advance, startPos.y, font.getWidth(text), font.getLineHeight());
