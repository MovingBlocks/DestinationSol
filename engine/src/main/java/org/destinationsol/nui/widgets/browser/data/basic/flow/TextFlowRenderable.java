 ...
 */
package org.destinationsol.nui.widgets.browser.data.basic.flow;
...
public class TextFlowRenderable implements FlowRenderable<TextFlowRenderable> {
    ...
    @Override
    public void render(Canvas canvas, Rectangle bounds, TextRenderStyle defaultRenderStyle) {
        ...
        Rectangle bottomBounds = Rectangle.createFromMinAndSize(bounds.minX(), bounds.maxY() - lineHeight, bounds.sizeX(), lineHeight);
