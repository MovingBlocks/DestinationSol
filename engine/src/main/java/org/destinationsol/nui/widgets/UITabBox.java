...
import org.destinationsol.nui.layouts.RowLayout;
...
public class UITabBox extends CoreWidget {
    ...
    public void onDraw(Canvas canvas) {
        if (!contents.isEmpty()) {
            ...
            Rectangle buttonRegion = Rectangle.createFromMinAndSize(region.minX(), region.minY(), region.width(), tabBarHeight);
            Rectangle boxRegion = Rectangle.createFromMinAndMax(region.minX(), region.minY() + tabBarHeight, region.width(), region.height());
