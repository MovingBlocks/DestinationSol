...
public interface UIWidget extends Iterable<UIWidget> {
     ...
     * @param sizeHint A {@link Vector2} representing how much available space is for this widget.
     * @return A {@link Vector2} which represents the preferred size of this widget.
     */
    Vector2 getPreferredContentSize(Canvas canvas, Vector2 sizeHint);

    Vector2 getMaxContentSize(Canvas canvas);
