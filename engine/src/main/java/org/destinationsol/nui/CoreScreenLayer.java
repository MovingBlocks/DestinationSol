...
import org.destinationsol.nui.animation.MenuAnimationSystem;
import org.destinationsol.nui.animation.MenuAnimationSystemStub;
...
import org.destinationsol.nui.layouts.ScrollableArea;
import org.destinationsol.nui.widgets.UIRadialRing;
...
public abstract class CoreScreenLayer extends AbstractWidget implements UIScreenLayer {
    ...
    public void onDraw(Canvas canvas) {
        Rectangle region = animationSystem.animateRegion(canvas.getRegion());
        if (isModal()) {
