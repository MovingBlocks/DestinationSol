...
public interface UiContainerElement extends UiElement {
     ...
     *
     * Is responsible for calling {@link #setParent(UiContainerElement)} on {@code element}.
     * @param element {@code UiElement} to add
     * @return Self for method chaining.
     */
    UiContainerElement addElement(UiElement element);
}
