...
public class ChooseMercenaryScreen extends InventoryOperationsScreen {
    ...
    public void initialise(SolApplication solApplication, InventoryScreen inventoryScreen) {
        KeyActivatedButton giveButton = new KeyActivatedButton("giveButton", "Give Items");
        ...
        KeyActivatedButton takeButton = new KeyActivatedButton("takeButton", "Take Items");
        ...
        KeyActivatedButton equipButton = new KeyActivatedButton("equipButton", "Equip Items");
