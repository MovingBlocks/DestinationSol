...
public class ShowInventory extends InventoryOperationsScreen {
    ...
    public void initialise(SolApplication solApplication, InventoryScreen inventoryScreen) {
        ...
        UIWarnButton equip1Button = new UIWarnButton("equip1Button", "Eq");
        ...
        UIWarnButton equip2Button = new UIWarnButton("equip2Button", "Eq2");
        ...
        UIWarnButton dropButton = new UIWarnButton("dropButton", "Drop");
