...
public class NewTutorialManager implements UpdateAwareSystem {
    ...
    public void start() {
        ...
        steps = new TutorialStep[] {
                ...
                new FlyToRandomWaypointAroundHeroStep(tutorialScreen, solGame.get(), 1.0f, 2.0f, "Fly to the waypoint."),
                new MessageStep(tutorialScreen, solGame.get(), "Section 2 - Weapons"),
                new FireGunStep(tutorialScreen, solGame.get(),gameOptions, isMobile, "Fire your gun"),
                ...
                new UseAbilityStep(tutorialScreen, solGame.get(), gameOptions, isMobile, "Use your ability"),
                new MessageStep(tutorialScreen, solGame.get(), "Abilities consume ability charges."),
                new MessageStep(tutorialScreen, solGame.get(), "Section 3 - Map"),
                ...
                new MessageStep(tutorialScreen, solGame.get(), "Section 4 - Money"),
                ...
                new MessageStep(tutorialScreen, solGame.get(), "Section 5 - Items"),
                new OpenScreenStep(tutorialScreen, nuiManager,
                ...
                new CheckItemEquippedStep(tutorialScreen,
                        solGame.get().getScreens().inventoryScreen,
                        false, "Equip an item."),
                new MessageStep(tutorialScreen, solGame.get(), "Section 6 - Weapon Mounts"),
                new MessageStep(tutorialScreen, solGame.get(), "All ships are equipped with up to two weapon mounts."),
                new MessageStep(tutorialScreen, solGame.get(), "Weapon mounts vary in size and socket."),
                new MessageStep(tutorialScreen, solGame.get(), "Weapon sizes are small or large."),
                new MessageStep(tutorialScreen, solGame.get(), "Weapon sockets are fixed or rotating."),
                new MessageStep(tutorialScreen, solGame.get(), "A weapon can only be equipped if both its size and socket match its mount."),
                new MessageStep(tutorialScreen, solGame.get(), "Section 7 - Shops"),
                ...
                new BuyItemStep(tutorialScreen,
                        ...
                        "Buy an item."),
                new MessageStep(tutorialScreen, solGame.get(), "Section 8 - Combat"),
                new DestroySpawnedShipsStep(tutorialScreen, solGame.get(), 1, "core:pirateSmall",
                        "core:blaster+core:gun", "Destroy all targets.",
                ...
                new MessageStep(tutorialScreen, solGame.get(), "Section 9 - Repair Kits"),
                ...
                new DestroySpawnedShipsStep(tutorialScreen, solGame.get(), 1, "core:pirateSmall",
                        "core:blaster+core:gun 0.5|core:smallShield+core:shield", "Destroy all targets.",
                        "Enemy ships can be tough.\nOpen the pause menu and select Respawn."),
