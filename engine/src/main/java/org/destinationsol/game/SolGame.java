...
public class SolGame {
    ...
    public SolGame(String shipName, boolean tut, boolean isNewGame, CommonDrawer commonDrawer, Context context) {
        ...
        camera = new SolCam(commonDrawer.dimensionsRatio);
        gameScreens = new GameScreens(drawer.r, solApplication, context);
        tutorialManager = tut ? new TutorialManager(commonDrawer.r, gameScreens, solApplication.isMobile(), solApplication.getOptions(), this) : null;
