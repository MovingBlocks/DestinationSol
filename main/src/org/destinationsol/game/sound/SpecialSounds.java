...
public class SpecialSounds {
    ...
    public PlayableSound getHitSound(boolean forMetal, DmgType dmgType) {
    ...
    public void playHit(SolGame game, SolObject o, Vector2 pos, DmgType dmgType) {
        ...
        PlayableSound sound = getHitSound(metal, dmgType);
        if (sound == null) {
            return;
        }
        OggSoundManager manager = game.getOggSoundManager();
        manager.play(game, sound, pos, o);
    }
    ...
    public void playColl(SolGame game, float absImpulse, SolObject o, Vector2 pos) {
        ...
        game.getOggSoundManager().play(game, metal ? metalColl : rockColl, pos, o, absImpulse * Const.IMPULSE_TO_COLL_VOL);
    }
}
