...
public class SolGame {
    private final AssetHelper myAssetHelper;
    ...
    private final OggSoundManager myOggSoundManager;
    private final OggMusicManager myOggMusicManager;
    ...
    public SolGame(SolApplication cmp, boolean usePrevShip, TextureManager textureManager, boolean tut, CommonDrawer commonDrawer) {
        ...
        myAssetHelper = myCmp.getAssetHelper();
        myOggSoundManager = myCmp.getSoundManager();
        myOggMusicManager = myCmp.getMusicManager();
        mySpecialSounds = new SpecialSounds(myOggSoundManager);
        ...
        myItemManager = new ItemManager(myTextureManager, myOggSoundManager, myEffectTypes, gameColors);
        myAbilityCommonConfigs = new AbilityCommonConfigs(myEffectTypes, myTextureManager, gameColors, myOggSoundManager);
    ...
    public OggSoundManager getOggSoundManager() {
        return myOggSoundManager;
    }
