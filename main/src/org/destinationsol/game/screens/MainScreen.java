...
public class MainScreen implements SolUiScreen {
    ...
    public void drawImgs(UiDrawer uiDrawer, SolApplication cmp) {
        ...
        if (hero != null) {
            ...
            //updateTextPlace(col1, row, Integer.toString(Math.round(hero.getMoney())), myMoneyExcessTp);
        }
    ...
    public void drawText(UiDrawer uiDrawer, SolApplication cmp) {
        ...
        myMoneyExcessTp.drawLeftAligned(uiDrawer);
    ...
    public static class TextPlace {
        ...
        public void draw(UiDrawer uiDrawer) {
            uiDrawer.drawStringCentered(text, pos.x, pos.y, FontSize.HUD, color);
        }

        public void drawLeftAligned(UiDrawer uiDrawer) {
            uiDrawer.drawStringLeftAligned(text, pos.x, pos.y, FontSize.HUD, color);
        }
    }
