...
public class CommonDrawer {
    ...
    public void drawString(String s, float x, float y, float fontSize, Color col) {
        if (s == null) return;
    ...
    public void drawStringCentered(String s, float x, float y, float fontSize, Color col) {
        if (s == null) return;
        myTextureChecker.onString(myFont.getRegion().getTexture());
        myFont.setColor(col);
        myFont.getData().setScale(fontSize / myOrigFontHeight);
    ...
    public void drawStringLeftAligned(String s, float x, float y, float fontSize, Color col) {
        if (s == null) return;
        myTextureChecker.onString(myFont.getRegion().getTexture());
        myFont.setColor(col);
        myFont.getData().setScale(fontSize / myOrigFontHeight);
