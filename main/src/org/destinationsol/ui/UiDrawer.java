...
public class UiDrawer {
    ...
    public void drawString(String s, float x, float y, float scale, Color tint) {
        if (myTextMode != null && !myTextMode) throw new AssertionError("drawing text in texture mode");
        myDrawer.drawString(s, x, y, scale * FONT_SIZE, tint);
    }

    public void drawStringCentered(String s, float x, float y, float scale, Color tint) {
        if (myTextMode != null && !myTextMode) throw new AssertionError("drawing text in texture mode");
        myDrawer.drawStringCentered(s, x, y, scale * FONT_SIZE, tint);
    }

    public void drawStringLeftAligned(String s, float x, float y, float scale, Color tint) {
        if (myTextMode != null && !myTextMode) throw new AssertionError("drawing text in texture mode");
        myDrawer.drawStringLeftAligned(s, x, y, scale * FONT_SIZE, tint);
    }
