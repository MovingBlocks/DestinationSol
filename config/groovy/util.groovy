...
def printUsage() {
    println ""
    println "Utility script for interacting with project items. General syntax:"
    println "  groovyw (type) (sub-command)"
    println "- 'type' may be module, meta, lib or facade - but so far for DestSol only module is supported"
    println ""
